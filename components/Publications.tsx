      ...
      <SectionReveal label="publications">
        ...
        >
          <div className="mb-10 flex flex-col gap-3">
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500 dark:text-[#8b949e]">Publications & Certifications</p>
              ...
              <ul className="mt-6 space-y-4 text-slate-700 dark:text-[#8b949e]">
                {publications.publications.map((item) => (
                  <li key={item.title}>
                    ...
                    <p className="mt-1 text-sm text-slate-600 dark:text-[#8b949e]">{item.source}</p>
                  </li>
                ))}
              </ul>
            </div>
