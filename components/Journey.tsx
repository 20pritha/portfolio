      ...
      <SectionReveal label="journey">
        ...
        >
          <div className="mb-10 flex flex-col gap-3">
            <p className="text-sm uppercase tracking-[0.35em] text-slate-500">Journey</p>
          ...
          <div ref={containerRef} className="relative mx-auto w-full">
            <div className="pointer-events-none absolute left-1/2 top-0 h-full w-px -translate-x-1/2 bg-slate-200" />
                      ...
                      <div className={alignLeft ? 'lg:col-start-1 lg:col-end-2 lg:text-right' : 'lg:col-start-1 lg:col-end-2'}>
                        {alignLeft && (
                          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-soft transition duration-300 group-hover:border-maroon group-hover:shadow-[0_0_0_16px_rgba(139,38,53,0.08)]">
                            ...
                            <p className="mt-4 text-lg font-semibold text-slate-950">{item.event}</p>
